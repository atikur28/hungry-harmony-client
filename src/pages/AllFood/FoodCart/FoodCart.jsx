...
const FoodCart = ({data}) => {
    const {food_name, food_image, food_category, price, quantity} = data || {};
    return (
        <div className="border rounded p-3">
            ...
            <Link><button className="btn btn-sm bg-green-600 hover:bg-green-600 font-bold text-white w-full">Details</button></Link>
        </div>
    );
};
